        ...
        <div className='justify-center align-center mt-8'>
            <div className=''>
                <div className='text-center mx-auto mb-4 mt-24'>
                    <p className="font-quicksand items-center font-bold text-2xl text-yellow-500 mb-4 ">
                        Popular Causes
                    </p>
                    <h2 className=" font-quicksand font-bold text-5xl text-blue-900 mb-4 max-w-[850px] ml-[22%] mt-8">
                ...
                {causesData.map((cause, index) => (
                    <div key={index} className="bg-gray-200 m-4 rounded-md w-[26%] h-160 flex flex-col justify-start items-center">
                        ...
                        <div className="mb-4 justify-center flex items-center">
                            <button className="justify-center border-b-4 font-semibold flex items-center border border-yellow-500 hover:border-yellow-700 border-b-2 p-3 text-gray-600 font-quicksand mb-4 m-2 rounded-full cursor-pointer">
                                Learn More
