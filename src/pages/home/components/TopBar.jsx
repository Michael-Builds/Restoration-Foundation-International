                ...
                <div className="flex lg:flex justify-between items-center">
                    <div className="flex lg:w-1/2  items-center justify-start">
                        <div className="text flex items-center justify-center flex-row h-16 px-10 text-center gap-2 first:-ml-8 ">
                            <FiPhone className="text-gray-500 h-4 w-4 mr-1 hover:text-yellow-500 cursor-pointer" />
                            <p className=" text-sm my-0 font-quicksand">+233 54 4541 587</p>
                        </div>

                        <div className="text flex items-center justify-center flex-row h-16 px-10 text-center gap-2 last:border-l-0">
                            <MdEmail className="text-gray-500 h-4 w-4 mr-1 hover:text-yellow-500 cursor-pointer" />
                    ...
                    <div className=" lg:w-1/2 flex items-center justify-end">
                        <div className="flex items-center h-16 text-0 justify-end gap-2">
                            <FaFacebook className="h-4 w-4 text-gray-500  mr-1 cursor-pointer hover:text-yellow-500" />
                            <FaInstagram className="h-4 w-4 text-gray-500  mr-1 cursor-pointer hover:text-yellow-500" />
                            <FaTwitter className="h-4 w-4 text-gray-500 mr-1 cursor-pointer hover:text-yellow-500" />
                            <FaLinkedin className="h-4 w-4 text-gray-500 mr-1 first: mr-8 cursor-pointer hover:text-yellow-500" />
                        </div>
                    </div>
                </div>
            </div>
