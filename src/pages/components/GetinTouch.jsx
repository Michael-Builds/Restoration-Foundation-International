        ...
        <div className="relative w-full py-12">
            <div className="container mx-auto flex flex-wrap items-center">
                ...
                <div className="w-full lg:w-1/2 lg:pr-10 -ml-12">
                    <form className="mt-6 mb-4 w-80 max-w-screen-lg sm:w-96 pt-4 pb-4 border border-gray-200 items-center  p-4 rounded-sm p-6 m-6 bg-gray-100">
                        ...
                        <Button className="mt-4 mb-4 p-4 font-quicksand font-medium border border-yellow-400 border-b-4 bg-transparent text-gray-800" fullWidth>
                            Get in touch
                        </Button>
                    </form>
